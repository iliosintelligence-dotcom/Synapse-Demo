...
(function () {
  ...
  function css() {
    ...
    st.textContent = [
      ...
      '.syn-mcard-row{display:flex;gap:calc(12px * var(--syn-mcard-k,1));',
      '  padding:calc(12px * var(--syn-mcard-k,1));align-items:flex-start;}',
      '.syn-mcard-img{width:calc(82px * var(--syn-mcard-k,1));',
      '  height:calc(82px * var(--syn-mcard-k,1));flex:none;border-radius:12px;',
      ...
      '.syn-mcard-ttl{font-size:calc(13px * max(var(--syn-mcard-k,1), .85));',
      '  color:#33332F;margin-top:3px;overflow:hidden;',
      '  text-overflow:ellipsis;white-space:nowrap;}',
      '.syn-mcard-loc{font-size:calc(12px * max(var(--syn-mcard-k,1), .85));color:#6E6E68;margin-top:2px;}',
