...
- **`synapse_moodboard_v1`** (browser `localStorage`): Dream Board pins and saved homes. Stays on-device, but Tayo **reads it server-side on every chat call**, so once transmitted it is processing under Synapse's control.
...
1. **Transparency / privacy notice at the point of capture.** A short, plain-language notice visible before or at the first Tayo message and linked persistently. NDPA requires that people know who is processing their data, why, on what lawful basis, how long, and their rights — even anonymously. Draft copy in §1C.
...
> **Anthropic sub-processor flag (important).** Tayo sends conversation content to Claude (Anthropic, US). That is both a cross-border transfer and third-party processing. The privacy notice must disclose "we use third-party AI providers to power Tayo," and a Data Processing Agreement posture should be confirmed with counsel. This is easy to miss because it is invisible in the UI.
...
## 2. AI disclosure for Tayo + verified/unverified labels

**Why this is Gate 1, not cosmetic.** Tayo is positioned as an "advisor," speaks warmly and confidently, and gives price context, yield figures and neighbourhood claims. Under consumer-protection and emerging AI-transparency norms, users must (a) know Tayo is an AI, and (b) not reasonably read Tayo's output as a **guarantee** or as **regulated financial/legal/real-estate advice**. The good news: Tayo's own **doctrine already says this** ("no financial, investment or legal guarantees — point people to professional verification"; "if something cannot be verified, say so"). The disclosure copy below simply makes the doctrine visible and legally load-bearing in the UI. It aligns with, and does not contradict, the doctrine.

### 2A. Ready-to-use — Tayo AI disclosure

> **DRAFT — requires Nigerian counsel review.** Align verbatim with the `DOCTRINE` constant in `toju-demo`.

**First-run / intro line (shown before or on Tayo's first message):**

> Hi, I'm Tayo — Synapse's **AI** property advisor. I help you think through renting, buying and neighbourhoods using real, verified listings. I'm not a person, and I'm not a lawyer, financial adviser or estate agent — treat what I say as **guidance to help you decide, not a guarantee or professional advice.** For anything that affects your money or your legal rights, please confirm with a qualified professional before you commit.

**Persistent short label (near the chat input, always visible):**

> Tayo is an AI advisor. Guidance only — not financial, legal or property-transaction advice. Not a guarantee.

**Standing footer / "About Tayo" expandable:**

> Tayo is an artificial-intelligence assistant built by Synapse. Tayo's estimates — including prices, yields, affordability, commute times and neighbourhood descriptions — are informational and can be incomplete or wrong. They are **not** valuations, financial advice, investment advice, legal advice, or a promise about any property's condition, title, availability or price. Always verify independently and take professional advice before making a decision. Tayo recommends only listings that Synapse has marked verified, but see our Verification Standards for exactly what "verified" does and does not warrant.

**Boundary micro-copy (for Tayo to fall back on when a user pushes for a guarantee — hand to toju-ai to bake into prompts):**
...
> **⏳ Not yet verified.** Synapse has **not** completed its checks on this listing. Details may be inaccurate, out of date, or unconfirmed. Tayo does not recommend unverified listings — treat anything here with extra caution and verify independently.
...
- the **accuracy of price, valuation, yield or affordability** figures (those are estimates, incl. Tayo's);
...
Full drafting waits for the agency-monetization phase, but flag the skeleton now so product decisions (verification desk, Tayo-negotiator, lead attribution) don't get made in a way that's hard to paper later.
...
4. **Tayo-as-negotiator authority + the negotiation floor.** Define the agency's authority granted to Tayo, that Tayo negotiates within an agency-set encrypted floor, and that outcomes are not guaranteed. Clarify Synapse is a facilitator, **not** the seller's agent or a party to the sale.
...
For digital-marketer, social-media-manager and toju-ai. I should be looped in on new marketing claims and Tayo behaviours early (per mandate), but immediate flags from existing copy:
...
- **Any "we guarantee you'll find/save/earn…"** framing — do not ship. It contradicts Tayo's doctrine and creates consumer-protection (FCCPA) exposure.
...
1. Publish the demo **privacy notice** (§1C) + one-line acknowledgement at Tayo's entry point; disclose the Anthropic sub-processor/cross-border transfer.
2. Ship the **Tayo AI disclosure** (§2A) and standardise **verified/unverified labels** (§2B) in the UI.
...
6. Sweep **marketing/Tayo copy** for guarantee-style claims (§6).
